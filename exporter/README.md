...
| `PENPOT_WASM_RENDER_IDLE_TIMEOUT`     | `300`   | Silence before a worker is terminated, in seconds |
| `PENPOT_WASM_IMAGE_CACHE_MB`          | `128`   | Per-worker image cache budget          |
...
them, and `PENPOT_EXPORT_MAX_CONCURRENT_JOBS` bounds the browser ones alongside.
